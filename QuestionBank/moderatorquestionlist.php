...
<body>
    <form action="moderatorquestionlist.php" method="POST">
	<h1>Table 1</h1>
...
if($res2['approval']==1){
    ...
    echo '<td><a href="approve4.php?approve='.$row['id'].'"  class="nav3">Approve</a></td>';
}
...
echo '<td><a href="edit5.php? edit=  ' . $row['id']  . '"  class="nav" >Edit</a></td>';
