...
<body>
    <form action="subquestionlist.php" method="POST">
	<h1>Table 1</h1>
...
echo '<td><a href="edit7.php? edit=  ' . $row['id']  . '"  class="nav" >Edit</a></td>';

echo '<td><a href="delete7.php?id=' . $row['id'] . '" class="nav1">Delete</a></td>';
if($row['type_id'] == 2){
    echo '<td>'.$a[0].'</td>';
    echo '<td>'.$a[1].'</td>';
    echo '<td>'.$a[2].'</td>';
